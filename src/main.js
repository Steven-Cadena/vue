...
//DEBEMOS CREAR UN OBJETO router DE LA CLASE VueRouter 
// QUE CONTIENE LAS RUTAS Y EL MODO DE NAVEGACION
const router = new VueRouter({
  routes,
  mode:"history"
});

//DEBEMOS DAR DE ALTA EL POBJETO ROUTER AL CREAR EL APP
new Vue({
  router, 
  render: h => h(App),
}).$mount('#app')
